                        ...
                        <form action="{{ route('empleado/informacion/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h4>Documento Personal DPI Imagen:</h4>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control dropify   @error('img_atras_dpi') is-invalid @enderror" type="file" id="img_atras_dpi" name="img_atras_dpi" required>
                                        @if ($errors->any())
                                        <div class="alert alert-danger">
                                            <ul>
                                                @foreach ($errors->all() as $error)
                                    ...
                                    @endif
                                        <input type="hidden" class="form-control" name="img_dpi_adverso_hidden" value="{{ $users->img_atras_dpi }}"
                                        readonly>
