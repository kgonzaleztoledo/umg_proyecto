                ...
                <div class="row align-items-center">
                    <div class="col">
                        <a href="{{ route('form/descuentos/page') }}">
                            <h3 class="page-title">Categoria Descuentos</h3>
                        </a>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">CRUD TIPO DESCUENTOS</li>
                        </ul>
                    </div>
    ...
    <script>
        Livewire.on('alert-add', function() {
            Swal.fire({
                ...
                if (true) {
                    window.location = '{{ url('form/descuentos/page') }}';
                }
            })
