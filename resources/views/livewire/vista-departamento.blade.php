                    ...
                    <tbody >
                        @foreach ($departamentos as $departamento)
                            <tr>
                                ...
                                <td align="justify" >{{ $departamento->descripcion }}</td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item"data-toggle="modal" data-target="#edit_personalDepatamento"
                                                wire:click='edit("{{ $departamento->id }}")'> <i
                            ...
                            <div id="edit_personalDepatamento" class="modal custom-modal fade" role="dialog" wire:ignore.self>
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Editar| Departamentos {{ $Id }}
                                            </h5>
